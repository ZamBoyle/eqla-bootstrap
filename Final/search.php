...
<div class="container bg-light">
    ...
    if (!empty($_POST["what"])) {
        ...
        if (count($produits) == 0) {
            ...
            //echo "<p>Vous avez cherché ce terme: <span class='font-weight-bold font-italic'>$what</span></p>";
...
?>
    <form action="search.php" method="post">
        <div class="form-group">
            <input type="email" class="form-control" id="searchInput" aria-describedby="Zone de rechercher" placeholder="Que recherchez-vous ?" required>
        </div>
        <div class="form-row">
            <div class="col">
