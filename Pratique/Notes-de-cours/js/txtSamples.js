...
document.addEventListener("DOMContentLoaded", function() {
    ...
    replaceElementContent(".blind", blindcodeImg);
    replaceElementContent(".blindcodeImg", blindcodeImg);
    replaceElementContent(".loremipsum", loremipsum);
    replaceElementContent(".bootstrap", bootstrap);

    function replaceElementContent(elementName, content) {
